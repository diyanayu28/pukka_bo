...
class M_setting extends CI_Model {
    ...
    public function addAction($data){
        ...
        $sql = "INSERT INTO 
                    default_menu
                    (menuName, menuDefaultPage, iconMenu, menuOrder, menuStyle, menuParentId, menuDescription)
                VALUES
                    ('$menuName','$pageId','$iconMenu','$menuOrder', '$menuStyle', '$menuParentId', '$description')";
        $query = $this->db->query($sql);
        return $query;
    }
