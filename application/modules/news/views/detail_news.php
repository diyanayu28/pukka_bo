...
<div class="panel">
    <div class="panel-body">
        ...
        <form id="validation-form" method="post" action="<?php echo site_url('news/detailAction');?>" class="form-horizontal" enctype="multipart/form-data">    
            <div class="form-panel">
                <div class="table-responsive">
                    ...
                    <table id="datalist" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            ...
                            <tr>
                                <div class="col-lg-9">
                                    <?php echo(!empty($image)) ? '<img class="avatar-view" src="'.base_url().'files/news/'.$image.'" style="width:200px;height:auto;border:8px solid #ccc">' : '';?>
                                </div>
                            </tr>
                        </thead>
                    </table>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                        <a href="<?php echo site_url('news/view')?>" class="btn btn-default btn-sm pull-center">
