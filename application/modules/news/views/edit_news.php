...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li><a href="<?php echo site_url('news/view');?>">List Data</a></li>
...
<div class="panel">
    <div class="panel-body">
        ...
        <form id="validation-form" method="post" action="<?php echo site_url('news/editAction');?>" class="form-horizontal" enctype="multipart/form-data">    
            <div class="form-panel">
                ...
                <div class="form-group">
                    <label class="col-md-2 col-sm-2 col-xs-12">
                        News Title <span class="required" style="color: red">*</span>
                    </label>
                    <div class="col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <textarea class='form-control' name='headline'><?php echo $headline; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 col-sm-2 col-xs-12">
                        News Content <span class="required" style="color: red">*</span>
                    </label>
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <textarea id='editor1' class='form-control' name='news_content' style='height:260px'><?php echo $news_content; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 col-sm-2 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        ...
                        <?php echo(!empty($image)) ? 'File Sebelumnya : <a href="'.base_url().'files/news/'.$image.'" target="_blank">'.$image.'</a>' : '';?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 col-sm-2 col-xs-12">
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <a href="<?php echo site_url('news/view');?>" class="btn btn-info">
                                Ya
                            </a> 
...
<script type="text/javascript"> 
  ...
  $(document).ready(function(){
            $( "#tag_name" ).autocomplete({
              source: "<?php echo site_url('statis/get_autocomplete/?');?>"
            });
        });
</script>   
