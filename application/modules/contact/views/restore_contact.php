<ol class="breadcrumb page-breadcrumb">
    ...
    <li><a href="<?php echo site_url('contact/view');?>">Tampil Data</a></li>
    <li class="active">Restore Data</li>
</ol>
<div class="page-header">
    <h1><span class="text-muted font-weight-light"><i class="page-header-icon fa fa-cube"></i>Restore <?php echo $this->title?> </h1>
</div>
<div class="panel">
    ...
    $(document).ready(function(){
        $('#datalist').dataTable({
            ...
            columns: [
                ...
                { "data": "name", "class" : "text-left", 'sortable' : true},
                { "data": "email", "class" : "text-left", 'sortable' : true},
                { "data": "subject", "class" : "text-left", 'sortable' : true},
                { "data": "date_received", "class" : "text-left", 'sortable' : true},
            ],
            "order" : [],
            "ajax": {
