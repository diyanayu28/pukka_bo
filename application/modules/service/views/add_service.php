...
<div class="panel">
    <div class="panel-body">
        <form id="validation-form" method="post" action="<?php echo site_url('service/addAction');?>" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <textarea id="editor1" class='form-control' name='description' style='height:260px'></textarea>
                    </div> 
                </div>
                <div class="form-group">
                    <label class="col-md-2 col-sm-2 col-xs-12">
