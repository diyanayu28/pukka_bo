...
<div class="panel">
    <div class="panel-body">
        ...
        <form id="validation-form" method="post" action="<?php echo site_url('tag/editAction');?>" class="form-horizontal" enctype="multipart/form-data">    
            <div class="form-panel">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="tag_name" class="form-control" value="<?php echo $tag_name?>">
                    </div>
                </div>  
                <div class="form-group">
