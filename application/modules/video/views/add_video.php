...
<div class="panel">
    <div class="panel-body">
        <form id="validation-form" method="post" action="<?php echo site_url('video/addAction');?>" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="form-control" name="link_embed"></textarea>
                    </div>
                </div>
