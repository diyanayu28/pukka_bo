    ...
    <div class="panel-body">
        <div class="table-responsive">
            ...
            <div class="box box-danger">
                <?php $this->load->view('petunjuk/petunjuk_simplecontent');?>    
            </div>
    ...
    $(document).ready(function(){
        $('#datalist').dataTable({
            ...
            columns: [
                ...
                { "data": "page_title", "class" : "text-left", 'sortable' : true},
                { "data": "posted_at", "class" : "text-center", "width":"14%", 'sortable' : false },
                { "data": "status", "class" : "text-center", 'sortable' : false}
            ],
            "order" : [],
            "ajax": {
