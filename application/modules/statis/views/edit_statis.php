...
<div class="panel">
    <div class="panel-body">
        ...
        <form id="validation-form" method="post" action="<?php echo site_url('statis/editAction');?>" class="form-horizontal" enctype="multipart/form-data">   
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <input type="text" name="page_title" class="form-control" value="<?php echo $page_title?>">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-md-2 col-sm-2 col-xs-12">
                        Page Content <span class="required" style="color: red">*</span>
                    </label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <textarea id='editor1' class='form-control' name='page_content' style='height:260px'><?php echo $page_content; ?></textarea>
                        </div>
                </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        ...
                        <input type="hidden" name="image_static" value="<?php echo $image?>">
                        <?php echo(!empty($image)) ? 'File Sebelumnya : <a href="'.base_url().'files/staticpage/'.$image.'" target="_blank">'.$image.'</a>' : '';?>
                    </div>
                </div>
