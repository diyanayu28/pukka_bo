<ol class="breadcrumb page-breadcrumb">
    ...
    <li><a href="<?php echo site_url('ref_kategori/view');?>">Tampil Data</a></li>
    ...
    $(document).ready(function(){
        $('#datalist').dataTable({
            ...
            columns: [
                ...
                { "data": "category_name", "class" : "text-left", 'sortable' : true},
                { "data": "category_group", "class" : "text-left", 'sortable' : true}
            ],
            "order" : [],
            "ajax": {
