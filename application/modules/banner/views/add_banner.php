...
<div class="panel">
    <div class="panel-body">
        <form id="validation-form" method="post" action="<?php echo site_url('banner/addAction');?>" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="label_banner" class="form-control" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="col-lg-9">
                            <div class="col-lg-9">
                                <div class="option">
                                    <input type="radio" name="i_status" id="optionsRadios1" value="Y"> Aktif
                                </div>
                                <div class="option">
                                    <input type="radio" name="i_status" id="optionsRadios1" value="N"> Tidak Aktif
                                </div>
                            </div>
                        </div>
                </div>
